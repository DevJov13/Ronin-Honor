...
public class policy_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GamePreferences = getSharedPreferences(GlobalConfig.appCode, MODE_PRIVATE);
        editGamePreferences = GamePreferences.edit();

        webview = findViewById(R.id.webView);
        webview.setWebViewClient(new WebViewClient());
        webview.loadUrl(GlobalConfig.policyURL);
    ...
    private void startApp() {
        Intent contentUI = new Intent(this, splash_screen.class);
